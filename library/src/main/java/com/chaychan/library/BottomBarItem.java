...
public class BottomBarItem extends LinearLayout {
    ...
    private void checkValues() {
        ...
        if (mUnreadTextBg == null){
            mUnreadTextBg = getResources().getDrawable(R.drawable.bottom_bar_shape_unread);
        }

        if (mMsgTextBg == null){
            mMsgTextBg = getResources().getDrawable(R.drawable.bottom_bar_shape_msg);
        }

        if (mNotifyPointBg == null){
            mNotifyPointBg = getResources().getDrawable(R.drawable.bottom_bar_shape_notify_point);
        }
    }
